...
//@Component
public class BuzzScraperTwo extends Thread {

    private SneakerService sneakerService;
    Sites buzz = Sites.Buzz;


    public BuzzScraperTwo(SneakerService sneakerService) {
        this.sneakerService = sneakerService;
    }

    @Override
    public void run() {
        print("Buzz 2 running...");
        Document document;
        ...
        try {
            ...
            for (int i = lastPageNumber; i > lastPageNumber / 2; i--) { // lastPageNumber / 2
                if (i == 0) {
