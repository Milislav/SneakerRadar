...
//@Component
public class SportVisionScraperWomen extends Thread {

    private SneakerService sneakerService;

    public SportVisionScraperWomen(SneakerService sneakerService) {
    ...
    public void run() {
        ...
        try {
            ...
            String url;
            document = Jsoup.connect("https://www.sportvision.mk/obuvki/zenski").timeout(1800000).get();
            ...
            for (int i = 0; i < lastPageNumber; i++) {
                if (i == 0) {
                    url = "https://www.sportvision.mk/obuvki/zenski";
                } else {
                    url = "https://www.sportvision.mk/obuvki/zenski/page-" + i;
                }
                ...
                for (int j = 0; j < pricesElements.size(); j++) {
                    ...
                    if (sneakerName.split(" ")[0].trim().equals("NEW") || sneakerName.split(" ")[0].trim().equals("SERGIO")) {
