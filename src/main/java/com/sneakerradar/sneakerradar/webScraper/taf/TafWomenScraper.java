...
public class TafWomenScraper extends Thread {
    ...
    public TafWomenScraper(SneakerService sneakerService, SneakerSizeTaf sneakerSizeTaf) {
        this.sneakerService = sneakerService;
        this.sneakerNumber = sneakerSizeTaf.womenSneakerNumber;
    }


    @Override
    public void run() {
        print("TafWomen running...");
        Document document;
        ...
        try {
            ...
            String url;
            document = Jsoup.connect("https://www.taf.mk/ProductCatalog?Segment=42&Grupa=01&Popust=False&CenaOd=0&CenaDo=0&PopustProcentOd=0&PopustProcentDo=0&Page=1").get();
            ...
            for (int i = 1; i <= lastPageNumber; i++) {
                if (i == 1) {
                    url = "https://www.taf.mk/ProductCatalog?Segment=42&Grupa=01&Popust=False&CenaOd=0&CenaDo=0&PopustProcentOd=0&PopustProcentDo=0&Page=1";
                } else {
                    url = "https://www.taf.mk/ProductCatalog?Segment=42&Grupa=01&Popust=False&CenaOd=0&CenaDo=0&PopustProcentOd=0&PopustProcentDo=0&Page=" + i;
                }
