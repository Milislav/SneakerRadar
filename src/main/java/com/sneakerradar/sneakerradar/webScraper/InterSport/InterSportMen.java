...
public class InterSportMen extends Thread {

    private SneakerService sneakerService;
    Sites InterSport = Sites.InterSport;

    public InterSportMen(SneakerService sneakerService) {
    ...
    public void run() {
        ...
        try {
            ...
            String url;
            document = Jsoup.connect("https://intersport.mk/ProductCatalog?Segment=28&Grupa=01").get();
            ...
            for (int i = 1; i <= lastPageNumber; i++) {
                if (i == 1) {
                    url = "https://intersport.mk/ProductCatalog?Segment=28&Grupa=01";
                } else {
                    url = "https://intersport.mk/ProductCatalog?Segment=28&Grupa=01&Popust=False&CenaOd=0&CenaDo=0&PopustProcentOd=0&PopustProcentDo=0&Page=" + i;
                }
